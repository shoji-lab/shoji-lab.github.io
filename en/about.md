      ...
      <div class="note-column">
        ...
        <div class="note-card" data-title="For Students of Shizuoka University" tabindex="0">
          ...
          <div class="note-body">
            ...
            <p>
              In this field, it is common to pursue employment after completing a master’s degree.
              Accordingly, our education and research schedule is designed with graduate study in mind.
              Students who plan to graduate after the bachelor’s program only are advised not to apply.
            </p>
        ...
        <div class="note-card" data-title="For Transfer Students" tabindex="0">
          ...
          <div class="note-body">
            ...
            <p>
              For master’s-level transfers, prior approval from the prospective supervisor is typically required.
        ...
        <div class="note-card" data-title="Important Notes on Lab Assignment" tabindex="0">
          ...
          <div class="note-body">
            ...
            <ul>
              <li><strong>Bachelor’s:</strong> At least one external presentation (including non-refereed domestic conferences)</li>
              <li><strong>Master’s:</strong> At least one international conference or journal publication</li>
            </ul>
            </p>
            <p>
        ...
        <div class="note-card" data-title="Weekly Schedule" tabindex="0">
          ...
          <div class="note-body">
            <p>
              ...
              Example weekly schedules for senior undergraduates and first-year master’s students are available.
            </p>
          </div>
        </div>
        ...
        <div class="note-card" data-title="Academic Activities" tabindex="0">
          ...
          <div class="note-body">
            ...
            <ul>
              ...
              <li>Kansai–Tokai DBWS (Workshops): 9 presentations</li>
