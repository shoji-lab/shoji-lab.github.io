...
.image-tile img {
    width: 100%;
    height: auto;
    object-fit: cover; /* 画像をトリム */
    filter: brightness(50%); /* 初期状態で暗くする */
    transition: filter 0.3s ease, transform 0.3s ease;
}

.image-tile a:hover img {
    filter: brightness(100%); /* ホバー時に鮮明にする */
}

.image-tile .caption {
    position: absolute;
    min-width: 150px; /* 最小幅を設定 */
    max-width: 80%; /* 最大幅を画像幅の80%に制限 */
    top: 50%;
    left: 50%;
    ...
    opacity: 1; /* 初期状態で表示 */
    transition: opacity 0.3s ease; /* ホバー時のフェードアウト */
}
...
.image-tile a:hover .caption {
    opacity: 0%; /* ホバー時に文字を非表示 */
}
</style>
...
<div class="image-tile">
    <a href="/member/yoshiyuki_shoji.html">
        ...
        <p class="grade">Lecturer</p></div>
    </a>
</div>

<h1>Master’s Students (2nd Year)</h1>
<div class="image-tile">
...
<div class="image-tile">
    <a href="/member/daichi_sugita.html">
        <img src="/assets/img/members/daichi_sugita.jpg" alt="Graduate student">
        <div class="caption">
        <h3 class="fullname">Daichi Sugita</h3>
        <p class="grade">M1</p></div>
    </a>
    <a href="/member/naoto_yazaki.html">
        <img src="/assets/img/members/naoto_yazaki.jpg" alt="Graduate student">
        <div class="caption">
...
<div class="image-tile">
    ...
    <a>
        <img src="/assets/img/members/no-photo-01.png" alt="Alumni">
        <div class="caption">
        <h3 class="fullname">Shota Sakamaki</h3>
