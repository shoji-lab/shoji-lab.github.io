...
## 論文
1. **スペックに基づくエンコーダと外れ値クラスタリングによるレビューからのマイナーな製品スペックの発見**  
著者: 吉原哉偉翔（静大）, 山本岳洋（兵庫県立大）, 莊司慶行（静大）    
発表会議: 第18回データ工学と情報マネジメントに関するフォーラム, 2026

2. **Expanding Aspect Queries into Review Sentence Fragments for Product Comparison via LLM-Generated Synthetic Reviews**  
